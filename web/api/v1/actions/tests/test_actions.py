...
def test_get_following_current_user(
    api_client, user_with_following_followers, second_user
):
...
def test_get_followers_current_user(
    api_client, user_with_following_followers, second_user
):
...
def test_get_following_other_user(
    api_client, user_with_following_followers, second_user
):
...
def test_get_followers_other_user(
    api_client, user_with_following_followers, second_user
):
